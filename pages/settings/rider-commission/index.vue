  ...
  <overlay-scrollbars class="main-content-wrap">
    <overlay-scrollbars class="page-extras d-flx-alc-jsb settings-extra">
      <div class="links-wrap">
        <nuxt-link to="/settings" v-if="isMerchant">Basic details</nuxt-link>
        ...
        <nuxt-link to="/settings/tax" v-if="isMerchant" class="active">Tax</nuxt-link>
        <nuxt-link to="/settings/discount" v-if="isMerchant">Discount</nuxt-link>
        ...
        <!-- <nuxt-link to="/settings/rider-commission" class="active">Rider Commissions</nuxt-link> -->
            ...
            <table class="table-content">
              ...
              <tbody class="tablebody">
                ...
                <tr v-if="!loading && commissions.length > 0" v-for="p in commissions" :key="p.id">
                  ...
                  <td>
                    <button class="btn btn-icon" @click="editCommission(p)" title="Edit" type="button">
                      <svg>
          ...
          <form @submit.prevent="saveCommission">
            <div class="modal-body" uk-overflow-auto>
              ...
              <label  class="form-input">
                ...
                <div class="form-input__input">
                  <input v-model="formData.commissionpoint" type="text">
                </div>
              ...
              <label  class="form-input">
                ...
                <div class="form-input__input">
                  <input v-model="formData.amountearned" type="text">
                </div>
