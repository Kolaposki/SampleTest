      ...
      <overlay-scrollbars class="table-wrapper no-deco">
        <!-- <form class="mt-2" enctype="multipart/form-data" @submit.prevent=""> -->
          ...
          <div :class=" formData.producttype == 'stocked_product' ? 'flex-width-1-2 less-gp' : 'flex-width-1-1 less-gp'">
            ...
            <!-- <label  class="form-input">
              <span class="form-input__label">Selling price</span>
              <div class="form-input__input">
                <input type="text" v-model="formData.sellingprice" placeholder="">
              </div>
              <span v-if="errorData.sellingprice" class="form-input__error-msg">Please enter a selling price</span>
            </label> -->
          </div>
          ...
          <div class="flex-width-1-1 less-gp">
            <label  class="form-input">
              ...
              <image-crop :update="formData.photo" ref="photo1" :pic="'photo1'" @image="photo1 = $event"/>
		  ...
		  <div class="flex-width-1-1 less-gp">
            <label  class="form-input">
              ...
              <image-crop :update="formData.photo2" ref="photo2" :pic="'photo2'" @image="photo2 = $event"/>
		  ...
		  <div class="flex-width-1-1 less-gp">
            <label  class="form-input">
              ...
              <image-crop :update="formData.photo3" ref="photo3" :pic="'photo3'" @image="photo3 = $event"/>
		  ...
		  <div class="flex-width-1-1 less-gp">
            <label  class="form-input">
              ...
              <image-crop :update="formData.photo4" ref="photo4" :pic="'photo4'" @image="photo4 = $event"/>
          ...
          <div class="d-flx-alc-jfe mt-3">
            ...
            <button type="submit" id="submitBtn" class="btn btn--primary ml-1" @click="saveEditProduct">
              + Update product
            </button>
          </div>
        <!-- </form> -->
	...
	methods: {
		async saveEditProduct() {
			...
			if(this.photo1.length > 0 || this.photo1 != '') {
				...
				// console.log('in file submission');
			...
			this.$store.dispatch('products/editProduct', data)
				.then(res =>{
					$('#submitBtn').attr('disabled', false).html('+ Update product')
					if(res.data.status) {
