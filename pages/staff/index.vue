    ...
    <div class="inner-main-wrapper">
      ...
      <ul v-if="!loading && filteredList.length > 0" class="grid mostly-3">
        <li v-for="(row, ix) in filteredList" v-bind:key="ix">
          <div class="card staff-card box-deco-bg">
            <div class="drop-down org-drop drop-set">
              ...
              <div class="drop-wrapper" data-drop-down>
                <ul class="drop-lists">
                  <li
                    class="drop-list-item" v-if="(user.rolepermission ? user.rolepermission[0].staff.changepassword:'') || isMerchant"
                  >
                    <button
                      class="btn btn-text"
                      type="button"
                  ...
                  <li class="drop-list-item" v-if="(user.rolepermission ? user.rolepermission[0].staff.editstaff:'') || isMerchant">
                    <button
                      class="btn btn-text"
                      type="button"
                      @click="editStaff(row)"
                  ...
                  <li class="drop-list-item" v-if="(user.rolepermission ? user.rolepermission[0].staff.deletestaff:'') || isMerchant">
                    <button
                      class="btn btn-text"
                      type="button"
            ...
            <div class="card__body">
              ...
              <div class="card__body--content">
                ...
                <p>
                  ...
                  <!-- <span v-if="row.role === 'store_attendant'" class="attendant">
                    Store attendant
                  </span>
                  <span v-if="row.role === 'kitchen'" class="kitchen">
                    Kitchen Staff
                  </span>
                  <span v-if="row.role === 'administrator'" class="admin">
                    Supervisor
                  </span> -->
                </p>
                <!-- <p class="email">
                ...
                <p class="branch">
                  {{
                    row.branchname == "" ? "Not Appplicable" : row.branchname
                  }}
                </p>
                <!-- <p
                  style="
                ...
                <!-- <div class="d-flx-alc-jc">
                  <span class="business-owner">
                    {{
                      row.usertoken != undefined && row.usertoken != null
                        ? row.usertoken.includes("pbkdf2")
                          ? "No Token"
                          : row.usertoken
                        : "No Token"
                    }}
                ...
                <!-- <div class="d-flx-alc-jc mt-2" v-else>
                  <div class="drop-down staff-drop">
                    <button v-if="row.role === 'store_attendant'" class="staff-btn btn-attendant" type="button">
                      <span>Store attendant</span>
                      <svg class="">
                        <use xlink:href="/uploads/icons.svg#drop-alt"></use>
                      </svg>
                    </button>
                    <button v-if="row.role === 'kitchen'" class="staff-btn btn-kitchen" type="button">
                      <span>Kitchen Staff</span>
                      <svg class="">
                        <use xlink:href="/uploads/icons.svg#drop-alt"></use>
                      </svg>
                    </button>
                    <button v-if="row.role === 'administrator'" class="staff-btn btn-admin" type="button">
                      <span>
                          Supervisor
                      </span>
                      <svg class="">
  ...
  methods: {
    ...
    async createStaff() {
      ...
      this.$store
        ...
        .then(async (res) => {
          $("#submitBtn").attr("disabled", false).html("+ Create User");
          if (res.data.status) {
            this.closeModal();
    ...
    //   }
      ...
      if (
        (this.formData.branchID == 0 ||
          ...
          this.formData.branchID[0] == "") &&
        this.formData.role != "business_owner"
      ) {
