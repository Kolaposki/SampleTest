...
module.exports = {
    ...
    head: {
        ...
        link: [
            ...
            {
                rel: "stylesheet",
                href: "https://fonts.googleapis.com/css2?family=Montserrat:wght@600;700&family=Rubik:wght@700&family=Source+Sans+Pro:wght@400;600;700&display=swap",
            },
            ...
            {
                rel: "stylesheet",
                href: "//cdn.jsdelivr.net/npm/intro.js@2.9.3/introjs.min.css",
            },
        ],
        script: [
            ...
            { type: "text/javascript", src: "/js/intro.js" },
            {
                ...
                src: "https://maps.googleapis.com/maps/api/js?key=AIzaSyDLRcwcS-hVc4H8Yejx15PMWWZ934CXgLs&libraries=places",
            },
            {
                type: "text/javascript",
    ...
    css: ["@/static/css/style.css", "~/assets/css/variables.scss"],
    build: {
        plugins: [
...
//         { src: "~/plugins/OnesignalSDK.js", mode: "client" },
    ...
    //
    axios: {
        baseURL: "https://3235-102-219-153-218.eu.ngrok.io/",
    ...
    //environment variables
     env: {
        BASE_URL: "https://3235-102-219-153-218.eu.ngrok.io/",
