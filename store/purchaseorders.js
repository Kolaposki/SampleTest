...
export const actions = {
	setPurchaseOrder(context, data) {
		localStorage.setItem('po_data', JSON.stringify(data))
	},
	setReceiveNote(context, data) {
		localStorage.setItem('receiveNote', JSON.stringify(data))
	},
	setGoodsReturn(context, data) {
		localStorage.setItem('goodsReturn', JSON.stringify(data))
	},
